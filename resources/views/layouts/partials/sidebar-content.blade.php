<div class="flex flex-col w-full h-full select-none">
    ...
    <div x-data="{ open: false }" x-on:keydown.escape.window="open=false" class="relative p-4">
        ...
        <nav x-cloak x-show="open" x-trap="open" x-on:click.outside="open=false" class="absolute left-0 z-50 m-4 bg-white border border-gray-300 rounded-lg shadow-md w-72 top-12 focus:outline-none" tabindex="-1">
            ...
            <div class="py-1.5 px-2 mt-1.5 border-t border-gray-200">
                ...
                <a href="{{ route('app.budgets.create') }}" class="flex items-center px-2.5 py-1.5 relative focus:outline-none border border-transparent focus:border-gray-300 focus:bg-gray-100 rounded-lg tracking-tight leading-relaxed" x-on:mouseenter="$focus.focus($el)" x-on:mouseout="">
    ...
    <div class="p-4">   
        ...
        <div x-data="{ open: false }" class="relative">
            ...
            <div x-cloak x-show="open" x-trap="open" x-on:click.outside="open=false" x-on:keydown.escape.window="open=false" class="absolute z-20 bottom-[110%] space-y-1 w-full border border-gray-300 bg-white rounded-lg shadow-sm p-2 focus:outline-none" tabindex="-1">
